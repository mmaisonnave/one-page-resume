...
\begin{itemize}
    \item Led an interdisciplinary project that integrated NLP and causal inference to extract causal graphs from a corpus of 1.8 million New York Times news articles, utilizing causality learning and time series analysis tools.\vspace{-0.22cm}
    \item The first step involved extracting information from the text using deep learning techniques, specifically LSTM and CNN neural networks, built upon representations created with large language models (BERT).\vspace{-0.22cm}
    \item The second step transformed the extracted information into time series data and applied causal discovery tools, including PCMCI, PC, DirectLiNGAM, and Vector Autoregression (VAR).\vspace{-0.22cm}
